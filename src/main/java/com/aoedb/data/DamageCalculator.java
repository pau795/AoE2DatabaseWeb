    ...
    public static class UnitStats {
        ...
        public void calculateDamage(Unit r){
            ...
            if(hasAttack) {
                ...
                else if (elevation == DOWNHILL) hillMultiplier = u.getCalculatedStat(Database.HILL_BONUS) / r.getCalculatedStat(Database.UP_HILL_RESIST);
                else hillMultiplier = u.getCalculatedStat(Database.HILL_REDUCTION) / r.getCalculatedStat(Database.DOWN_HILL_RESIST);
