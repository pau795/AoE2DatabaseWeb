...
public class Database {
    ...
    public final static List<String> translatedFiles = new ArrayList<>(Arrays.asList(
        Database.BONUS_LIST,
        Database.BUILDING_DESCRIPTION,
        Database.BUILDING_GROUPS,
        Database.BUILDING_LIST,
        Database.CIVILIZATION_GROUPS,
        Database.CIVILIZATION_LIST,
        Database.CIVILIZATION_STYLE,
        Database.CLASS_LIST,
        Database.GATHERING_RATES,
        Database.HISTORY_GROUPS,
        Database.HISTORY_LIST,
        Database.HISTORY_TEXT,
        Database.PERFORMANCE_GROUPS,
        Database.PERFORMANCE_LIST,
        Database.STRINGS,
        Database.TAUNT_LIST,
        Database.TECH_DESCRIPTION,
        Database.TECH_GROUPS,
        Database.TECH_LIST,
        Database.TYPE_LIST,
        Database.UNIT_DESCRIPTION,
        Database.UNIT_GROUPS,
        Database.UNIT_LIST
    ));
